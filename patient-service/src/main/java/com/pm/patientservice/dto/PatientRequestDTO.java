...
public class PatientRequestDTO {
    ...
    @NotNull(groups= CreatePatientValidationGroups.class, message = "Registered date is required")
    ...
    public @NotBlank(message = "Address is reuired") String getAddress() {
        return address;
    }

    public void setAddress(@NotBlank(message = "Address is reuired") String address) {
